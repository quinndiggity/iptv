...
common::Error PipeClient::Write(const void* data, size_t size, size_t* nwrite_out) {
  return pipe_write_client_->Write(data, size, nwrite_out);
}

common::Error PipeClient::Read(char* out, size_t max_size, size_t* nread) {
  return pipe_read_client_->Read(out, max_size, nread);
}

common::Error PipeClient::Read(unsigned char* out, size_t max_size, size_t* nread) {
  return pipe_read_client_->Read(out, max_size, nread);
}
...
common::Error PipeClient::DoClose() {
