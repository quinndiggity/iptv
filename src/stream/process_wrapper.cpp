...
common::Error ProcessWrapper::StreamDataRecived(common::libev::IoClient* client) {
  ...
  if (err) {  // i don't want handle spam, comand must be formated according protocol
    return err;
  }
...
void ProcessWrapper::DataReceived(common::libev::IoClient* client) {
  common::Error err = StreamDataRecived(client);
  if (err) {
    DEBUG_MSG_ERROR(err, common::logging::LOG_LEVEL_ERR);
    // client->Close();
    // delete client;
...
common::Error ProcessWrapper::HandleRequestCommand(common::libev::IoClient* client,
                                                   protocol::sequance_id_t id,
                                                   int argc,
                                                   char* argv[]) {
  UNUSED(id);
...
common::Error ProcessWrapper::HandleResponceCommand(common::libev::IoClient* client,
                                                    protocol::sequance_id_t id,
                                                    int argc,
                                                    char* argv[]) {
  UNUSED(client);
...
common::Error ProcessWrapper::HandleRequestStopStream(common::libev::IoClient* client,
                                                      protocol::sequance_id_t id,
                                                      int argc,
                                                      char* argv[]) {
  protocol::protocol_client_t* pclient = static_cast<protocol::protocol_client_t*>(client);
...
common::Error ProcessWrapper::HandleRequestRestartStream(common::libev::IoClient* client,
                                                         protocol::sequance_id_t id,
                                                         int argc,
                                                         char* argv[]) {
  protocol::protocol_client_t* pclient = static_cast<protocol::protocol_client_t*>(client);
