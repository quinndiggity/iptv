...
public:
  ...
  void SetLocation(const std::string &location =
                       "segment%05d.ts"); // String; Default: "segment%05d.ts"
  void SetPlayLocation(const std::string &play_location =
                           "playlist.m3u8"); // String; Default: "playlist.m3u8"
  void
  SetTargetDuration(guint duration = 15); // Range: 0 - 4294967295 Default: 15
  void SetPlayListRoot(const std::string &play_root); // String, Default: null
  void
  SetPlaylistLenght(guint duration = 5); // Range: 0 - 4294967295 Default: 5
};
